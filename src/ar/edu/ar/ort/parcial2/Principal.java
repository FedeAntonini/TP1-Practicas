...
public class Principal {
	...
	public static void main(String[] args) {
		...
		ingresarSelloBasico(comp, "GR", "1029-Ku-GR", 0.72f, Formato.CUADRADO, Impresion.HUECOGRABADO, Disenio.FIGURA_ALEGORICA);
		ingresarSelloBasico(comp, "GR", "1036-Ku-GR", 0.72f, Formato.ALARGADO, Impresion.TIPOGRAFÍA, Disenio.FIGURA_ALEGORICA);
		ingresarSelloBasico(comp, "GR", "1129-Ky-GR", 0.72f, Formato.CUADRADO, Impresion.TIPOGRAFÍA, Disenio.FIGURA_ALEGORICA);
		ingresarSelloBasico(comp, "UK", "1999-Ks-UK", 0.70f, Formato.HEXAGONAL, Impresion.TROQUELADO, Disenio.FIGURA_ALEGORICA);
		...
		ingresarConmemorativo(comp, "SU", "0087-Su-AR", 0.88f, Formato.ALARGADO, Impresion.TROQUELADO, Tematica.CEREMONIAL);
		ingresarConmemorativo(comp, "ES", "0078-Es-AR", 0.75f, Formato.REDONDO, Impresion.HUECOGRABADO, Tematica.CEREMONIAL);
		ingresarConmemorativo(comp, "ES", "0076-Es-AR", 0.72f, Formato.ALARGADO, Impresion.HUECOGRABADO, Tematica.HISTOGRAFICA);
		ingresarConmemorativo(comp, "PE", "0080-Es-AR", 0.50f, Formato.CUADRADO, Impresion.HUECOGRABADO, Tematica.PATRIA);
		ingresarConmemorativo(comp, "SU", "0017-Su-IR", 0.80f, Formato.REDONDO, Impresion.TROQUELADO, Tematica.CEREMONIAL);
	...
	private static void ingresarSelloBasico(CentroDeCompilacion comp, String pais, String pie, 
											float valorFacial, 
											Formato formato, 
											Impresion impre, Disenio disenio){
	...
	private static void ingresarSemiPostal(CentroDeCompilacion comp, String pais, String pie, 
										   float valorFacial, 
										   Formato formato, 
										   Impresion impre){
		try {
	...
	private static void ingresarConmemorativo (CentroDeCompilacion comp, String pais, String pie, 
			   									float valorFacial, 
			   									Formato formato, 
			   									Impresion impre,
			   									Tematica tema) {
	...
	private static void realizarVentaSello(CentroDeCompilacion comp, 
											String s,
											int credencial, 
											String Contacto) {
		try {
